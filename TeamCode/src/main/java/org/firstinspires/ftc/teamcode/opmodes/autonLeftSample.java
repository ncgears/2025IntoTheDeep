...
@Autonomous(name="Sample Left Auton", group="JRB")
//@Disabled
public class
autonLeftSample extends OpMode {
    ...
    enum States {
        ...
        MANIP_SAMPLE_HIGH, //Move manipulator to high sample
...
//                    .transitionWithPointerState( () -> (robot.alliance != Constants.Alliance.NONE), States.STRAFE_CLEAR)
                ...
                .state(States.INIT_GYRO)
                    .onEnter( () -> {
                        robot.setYawOffset(90.0); //start left of robot toward drivers (+90)
                    })
                    .transition( () -> (true))
